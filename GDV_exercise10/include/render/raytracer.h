...
struct RayTracerParameters {
    enum class RenderMode { Depth, Position, Normal, Whitted, Path, VolumetricPath };

    RenderMode mode{RenderMode::VolumetricPath};
...
public:
    ...
    Color volumetricPathIntegrator(const Ray& cameraRay) const;
