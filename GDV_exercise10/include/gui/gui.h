...
public:
    ...
    GLView* addGLView(const Scene& scene);
    RayTracerView* addRayTracerView(RayTracer& rayTracer);
    SphereTracerView* addSphereTracerView(SphereTracer& sphereTracer);
