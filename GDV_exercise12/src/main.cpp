...
public:
                          ...
                          /* gl_minor */ 1}
    {
        ...
        // TODO: enable this for the Spectral to RGB task, disable this for the Gaussian blur task
        if constexpr (/* Spectral to RGB */ (true)) {
            gui->addSpectralToRGBView();
        }
        else // 3D scene
        {
            ...
            struct MaterialDatabase {
                ...
                const Material smoke{Material::Null{}, {}, {}, Material::Absorption{2.0f}};
                const Material redGlass{glass, {}, {}, Material::Absorption{{1.0f, 5.0f, 5.0f}}};
            ...
            if constexpr (/* Christmas Special */ (false)) {
                ...
                //                    {Matrix3D::scale(0.5f), {0.0f, -0.017f, -0.5f}}});
                scene.addInstance(
                    {"../meshes/gdv.obj", {materials.blueEmitter}, {{}, {0.0f, 0.5f, -1.0f}}});
                for (uint32_t i = 0; i < 5; ++i)
                    scene.addInstance({"../meshes/xyz_rgb_dragon.obj",
                                       {materials.roughGold},
                                       {Matrix3D::scale(0.1f),
                                        {static_cast<float>(i) * 0.75f - 1.5f, 0.0f, -0.5f}}});
