...
class SpectralToRGBView final : public nanogui::ImageView {
public:
    SpectralToRGBView(nanogui::Widget* parent, Toolbar* toolbar);
...
private:
    Texture image;
    nanogui::ref<nanogui::Texture> texture;
    nanogui::ref<nanogui::Widget> spectralToRGBControls;
    SpectralToRGB spectralToRGBConverter;
};
