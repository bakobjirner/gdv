...
private:
    ...
    /// framebuffer for rendering the primary image before postprocessing
    GLFramebuffer primaryFramebuffer;
    /// framebuffers for doing postprocessing
    GLFramebuffer auxillaryFramebuffers[3];

    /// post-processing shader for blurring
    BlurShader blurShader;
    /// shader for rendering out the final image
